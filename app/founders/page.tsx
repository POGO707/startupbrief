...
import { founderArticles, heroSideArticles } from "@/lib/data";

export const metadata: Metadata = {
  title: "Founders | Startup Brief",
  description: "The latest in founders.",
};
...
export default function FoundersPage() {
  ...
  featured = founderArticles[0];
  gridNews = founderArticles.slice(1);
    ...
    <>
      ...
      <main id="main-content" style={{ minHeight: "100vh" }}>
        ...
        <div className="section" style={{ paddingBottom: 0 }}>
          <div className="container">
            <div className="section-header">
              <h1 className="section-header-title">FOUNDERS</h1>
            </div>
          </div>
        </div>
                ...
                <Link href={"#"} className="hero-main-link">
                  <div className="hero-main-image img-hover">
                    <Image
                      ...
                      alt={(featured as any)?.title || "Founders"}
                      fill
                  ...
                  <div className="hero-main-content">
                    <span className="badge">{(featured as any)?.category || "Founders"}</span>
                    <h2 className="hero-main-title link-headline">{(featured as any)?.title || "Featured Founders Story"}</h2>
                  ...
                  {(typeof latestNews !== 'undefined' ? latestNews : []).map((item, i) => (
                    <article key={i} style={{ display: "grid", gridTemplateColumns: "32px 1fr", gap: 16, alignItems: "start", padding: "16px 0", borderBottom: "1px solid var(--color-border)" }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column" }}>
                        <Link href="#" className="badge" style={{ marginBottom: 6, alignSelf: "flex-start" }}>{(item as any).category || "Founders"}</Link>
        ...
        <section className="section editorial-border-top">
          <div className="container">
            <div className="section-header">
              <h2 className="section-header-title">LATEST IN FOUNDERS</h2>
            </div>
