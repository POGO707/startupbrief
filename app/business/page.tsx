...
import { businessArticles, heroSideArticles, startupArticles } from "@/lib/data";

export const metadata: Metadata = {
  title: "Business | Startup Brief",
  description: "The latest in business.",
};
...
export default function BusinessPage() {
  ...
  featured = businessArticles[0];
  gridNews = businessArticles.slice(1).concat(startupArticles).slice(0, 4);
    ...
    <>
      ...
      <main id="main-content" style={{ minHeight: "100vh" }}>
        ...
        <div className="section" style={{ paddingBottom: 0 }}>
          <div className="container">
            <div className="section-header">
              <h1 className="section-header-title">BUSINESS</h1>
            </div>
          </div>
        </div>
                ...
                <Link href={"#"} className="hero-main-link">
                  <div className="hero-main-image img-hover">
                    <Image
                      ...
                      alt={(featured as any)?.title || "Business"}
                      fill
                  ...
                  <div className="hero-main-content">
                    <span className="badge">{(featured as any)?.category || "Business"}</span>
                    <h2 className="hero-main-title link-headline">{(featured as any)?.title || "Featured Business Story"}</h2>
                  ...
                  {(typeof latestNews !== 'undefined' ? latestNews : []).map((item, i) => (
                    <article key={i} style={{ display: "grid", gridTemplateColumns: "32px 1fr", gap: 16, alignItems: "start", padding: "16px 0", borderBottom: "1px solid var(--color-border)" }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column" }}>
                        <Link href="#" className="badge" style={{ marginBottom: 6, alignSelf: "flex-start" }}>{(item as any).category || "Business"}</Link>
        ...
        <section className="section editorial-border-top">
          <div className="container">
            <div className="section-header">
              <h2 className="section-header-title">LATEST IN BUSINESS</h2>
            </div>
