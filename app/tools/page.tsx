...
import { topTools, aiArticles } from "@/lib/data";
...
export default function AIToolsPage() {
  ...
  tools = topTools;
  categories = ["Coding", "AI Assistant", "Image Generation", "Search", "Productivity"];
                ...
                <Link href={"#"} className="hero-main-link">
                  <div className="hero-main-image img-hover">
                    <Image
                      ...
                      alt={(featured as any)?.title || "AI Tools"}
                      fill
                  ...
                  <div className="hero-main-content">
                    <span className="badge">{(featured as any)?.category || "AI Tools"}</span>
                    <h2 className="hero-main-title link-headline">{(featured as any)?.title || "Featured AI Tools Story"}</h2>
                  ...
                  {(typeof latestNews !== 'undefined' ? latestNews : []).map((item, i) => (
                    <article key={i} style={{ display: "grid", gridTemplateColumns: "32px 1fr", gap: 16, alignItems: "start", padding: "16px 0", borderBottom: "1px solid var(--color-border)" }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column" }}>
                        <Link href="#" className="badge" style={{ marginBottom: 6, alignSelf: "flex-start" }}>{(item as any).category || "AI Tools"}</Link>
