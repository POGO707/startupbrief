...
import { technologyArticles, heroSideArticles } from "@/lib/data";

export const metadata: Metadata = {
  title: "Technology | Startup Brief",
...
export default function TechnologyPage() {
  ...
  featured = technologyArticles[0];
  gridNews = technologyArticles.slice(1);
    ...
    <>
      ...
      <main id="main-content" style={{ minHeight: "100vh" }}>
        ...
        <div className="section" style={{ paddingBottom: 0 }}>
          <div className="container">
            <div className="section-header">
              <h1 className="section-header-title">TECHNOLOGY</h1>
            </div>
          </div>
        </div>
                ...
                <Link href={"#"} className="hero-main-link">
                  <div className="hero-main-image img-hover">
                    <Image
                      ...
                      alt={(featured as any)?.title || "Technology"}
                      fill
                  ...
                  <div className="hero-main-content">
                    <span className="badge">{(featured as any)?.category || "Technology"}</span>
                    <h2 className="hero-main-title link-headline">{(featured as any)?.title || "Featured Technology Story"}</h2>
                  ...
                  {(typeof latestNews !== 'undefined' ? latestNews : []).map((item, i) => (
                    <article key={i} style={{ display: "grid", gridTemplateColumns: "32px 1fr", gap: 16, alignItems: "start", padding: "16px 0", borderBottom: "1px solid var(--color-border)" }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column" }}>
                        <Link href="#" className="badge" style={{ marginBottom: 6, alignSelf: "flex-start" }}>{(item as any).category || "Technology"}</Link>
        ...
        <section className="section editorial-border-top">
          <div className="container">
            <div className="section-header">
              <h2 className="section-header-title">LATEST IN TECHNOLOGY</h2>
            </div>
